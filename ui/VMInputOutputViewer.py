...
class VMInputOuputViewer(PluginViewer):
    def __init__(self, input_set, output_set, output_ctx, title='Input/Output Analysis'):
        ...
        self.brush_map = {0:QtGui.QBrush(QtCore.Qt.white),  # unselected values
                          1:QtGui.QBrush(QtCore.Qt.yellow),  # input values color
                          2:QtGui.QBrush(QtCore.Qt.red),  # output values color
                          3:QtGui.QBrush(QtCore.Qt.green)}  # BOTH values, mix of both colors
